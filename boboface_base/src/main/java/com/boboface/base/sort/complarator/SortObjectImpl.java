package com.boboface.base.sort.complarator;
...
import com.boboface.base.sort.ISortObject;
import com.boboface.base.sort.rule.OrderRule;
...
public class SortObjectImpl implements ISortObject {
	...
	private Object getValue(Object obj, String propertyName) throws IllegalArgumentException, IllegalAccessException{
		...
		if(proNames.length == 1){
			...
			String newPropertyName = StringTypeConversion.stringsToString(".", newProNames);

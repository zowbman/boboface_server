...
import net.zowbman.base.properties.reader.PropertiesReaderAbstract;
import net.zowbman.base.properties.reader.Reader;
...
public class CodeHelper {
	...
	public enum CODE{
		...
		//高权 400~499
		D200400,//启用高权状态成功,3秒后重置页面
		D200401,//退出高权状态成功,3秒后重置页面
		D200402,//高权密钥错误
		//--
		D300000;//未知错误
	}
